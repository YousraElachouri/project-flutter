...
class AjouModifContactPage extends StatefulWidget {
  const AjouModifContactPage({Key? key, this.model, this.isEditMode = false})
      : super(key: key);
  final Contact? model;
  ...
  @override
  State<AjouModifContactPage> createState() => _AjouModifContactPage();
}

class _AjouModifContactPage extends State<AjouModifContactPage> {
